...
class ReplyBundleGenerator
{
    ...
    public function generate(
        ...
        $user = implode("\n", [
            ...
            '- When it is not the opening post, make the target clear from the words themselves:',
            '  quote the line you are answering with "> ", or refer to what was said',
            '  ("the timeout you mentioned", "the cache thing above"). The quote is usually enough.',
            ...
            '',
            // Naming the person at the start is the single most artificial habit
            // a model falls into on a forum thread. Nobody writes that way.
            'NEVER begin a reply with a name or a handle. Not "Alice, you are right", not "@alice thanks",',
            'not your own name, not the thread author\'s. The very first word must already be the answer.',
            'If naming somebody genuinely helps, do it inside a sentence, never as the opening word.',
            '',
